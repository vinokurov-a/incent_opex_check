...
| `03-incent.opex.check_cpb.ipynb` | Проверка Cost Per Buyer (CPB) | [03_README.md](03_README.md) |
| `04-incent.opex.check_c2p.ipynb` | Проверка Conversion to Payer (C2P) | [04_README.md](04_README.md) |
| `05-incent.opex.check_ret.ipynb` | Проверка Retention (Ret) | [05_README.md](05_README.md) |
